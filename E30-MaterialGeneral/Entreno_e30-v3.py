# -*- coding: utf-8 -*-
"""
Created on Thu Mar 20 08:19:03 2025
...
def load_and_prepare_data_all_descripcions(XLSX,validated_path, classif_cleaned_path):
    """
    Carrega la mostra validada i Classif, i genera tants
    InputExamples com descripcions ICS hi hagi per un codi concret.
    """
    df_val = pd.read_excel(XLSX, sheet_name=validated_path)
    df_classif = pd.read_excel(XLSX, sheet_name=classif_cleaned_path)
...
def main():
    XLSX          = r"C:/Users/ariad/Documents/GitHub/CatalegML/E30 - Material General/Cataleg_E30_New.xlsx"
    
    validated_path       = "Entreno"
    classif_cleaned_path = "E30"
    model_folder         = r"C:/Users/ariad/Documents/GitHub/CatalegML/E30 - Material General/initial_model"
    output_trained_model = r"C:/Users/ariad/Documents/GitHub/CatalegML/E30 - Material General/initial_model-v1"
    checkpoint_dir       = "checkpoints_v1"

    # 1) Crear tots els exemples
    training_examples = load_and_prepare_data_all_descripcions(XLSX,validated_path, classif_cleaned_path)
